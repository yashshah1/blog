...
**Disclaimer 2**: _This story, unlike the others, has a second person involved, and for the sake of his (yes, I know I eliminated half the possibilities) privacy, let's name him Mr A._
...
{% include image.html url="/assets/4/bug-in-production.gif" local=true %}
